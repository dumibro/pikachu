...
module.exports = {
    ...
    BOTSK: process.env.BOT_NAME === undefined ? '𝙺𝙸𝙽𝙶 𝙰𝚂𝚃𝙴𝚁𝙸𝚇|:😻' : process.env.BOT_NAME,
    ...
    SLINK: process.env.SOCIAL_MEDIA === undefined ? 'wa.me/94781307901/' : process.env.SOCIAL_MEDIA,
    TAGPLK: process.env.TAG_HEADER === undefined ? '*𝙰𝚂𝚃𝙴𝚁𝙸𝚇 𝙷𝙴𝚁𝙴🍃*' : process.env.TAG_HEADER,
